...
<img className="centered" src="/img/menu-diff-merge.png" />

This will open the compare interface.

<img className="centered" src="/img/diff-merge-interface.png" />

Choose the source drive on the top left and the target drive on the right using the dropdowns.

<img className="centered" src="/img/diff-merge-select-source.png" />
...
<img className="centered" src="/img/diff-merge-individual-file.png" />
...
<img className="centered" src="/img/diff-merge-not-owner.png" />
